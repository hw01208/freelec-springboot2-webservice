...
import com.hanzoel.book.springboot.config.auth.SecurityConfig;
...
public class HelloControllerTest {
    ...
    @Test
    public void hello_be_returned() throws Exception {
    ...
    @WithMockUser(roles = "USER")
    @Test
    public void helloDto_be_returned() throws Exception {
        String name = "hello";
        int amount = 1000;
